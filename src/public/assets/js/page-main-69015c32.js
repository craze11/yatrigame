                    ...
                    ? (o(),
                      de(
                        L,
                        {
                          ...
                          size: "large",
                          color:
                            "linear-gradient(180deg, #D9AD82 0%, #222121 100%)",
                          onClick: a(f),
                        },
                        {
                          icon: P(() => [
